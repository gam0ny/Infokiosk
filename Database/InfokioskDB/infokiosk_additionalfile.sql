...
CREATE TABLE `additionalfile` (
  ...
  `File` blob,
  `MediaFileTypeId` int(11) DEFAULT NULL,
  `ArticleId` char(38) DEFAULT NULL,
  PRIMARY KEY (`Id`),
  KEY `MediaFileTypeId_idx` (`MediaFileTypeId`),
  KEY `ArticleId_idx` (`ArticleId`),
  CONSTRAINT `ArticleId` FOREIGN KEY (`ArticleId`) REFERENCES `article` (`Id`),
  CONSTRAINT `MediaFileTypeId` FOREIGN KEY (`MediaFileTypeId`) REFERENCES `mediafiletype` (`Id`)
...
-- Dump completed on 2019-05-30 21:16:20
